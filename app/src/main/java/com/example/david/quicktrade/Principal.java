    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bbdd.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adaptador = new ArrayAdapter<String>(Principal.this, android.R.layout.simple_list_item_1, listado);
                        ...
                        if (!TextUtils.isEmpty(nombre)) {
                            if (!TextUtils.isEmpty(apellidos)) {
                                if (!TextUtils.isEmpty(direccion)) {
                                    ...
                                    Toast.makeText(Principal.this, "Usuario Añadido", Toast.LENGTH_LONG).show();

                                } else {
                                    Toast.makeText(Principal.this, "Debes introducir una direccion", Toast.LENGTH_LONG).show();
                                }
                            } else {
                                Toast.makeText(Principal.this, "Debes introducir un apellido", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(Principal.this, "Debes introducir un nombre", Toast.LENGTH_LONG).show();
                        }

                    } else {
                        Toast.makeText(Principal.this, "Debes introducir un correo", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(Principal.this, "Debes introducir un nombre de usuario", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        botonModificar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(nombreusuario)){
                    ...
                    Toast.makeText(Principal.this, "El elemento se ha modificado", Toast.LENGTH_LONG).show();
                }
                else{
                    Toast.makeText(Principal.this, "Debes introducir un nombre de usuario", Toast.LENGTH_LONG).show();
